                                    ...
                                    <div class="col-xs-9">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="supplier" id="nama_supplier"
                                                   onfocus="cc()" type="text">
                                            <!-- </a> -->
                                        </div>
                                    </div>
                                    <div class="col-xs-1">
                                        <div class="form-group">
                                            <button class="btn btn-xs" onclick="search_table()"><i
                                                        class="fa fa-search"></i></button>
                                            <button class="btn btn-xs" onclick="refresh_table()"><i
                                ...
                                <form class="form-horizontal" role="form" id="formAksi">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                                            Nama </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_nama" name="supplier_nama"
                                                   placeholder="nama" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                                            Alamat </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_alamat" name="supplier_alamat"
                                                   placeholder="Alamat" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Kode
                                            Provinsi </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="kode_provinsi" name="kode_provinsi"
                                                   placeholder="Kode Provinsi" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Kode
                                            Kota </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="kode_kota" name="kode_kota" placeholder="Kode Kota"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="kode_kecamatan" name="kode_kecamatan"
                                                   placeholder="Kode Kecamatan" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Kode
                                            Pos </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_kodepos" name="supplier_kodepos"
                                                   placeholder="Kode Pos" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                                            Fax </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_fax" name="supplier_fax" placeholder="Fax"
                                                   class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> No
                                            HP </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_nohp" name="supplier_nohp"
                                                   placeholder="No HP" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> No
                                            Rekening </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_norek" name="supplier_norek"
                                                   placeholder="No Rekening" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                                            Rekan </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_rekan" name="supplier_rekan"
                                                   placeholder="Rekan" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                                            Bank </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_bank" name="supplier_bank"
                                                   placeholder="Kode Supplier" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1">
                                            Keterangan </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_ket" name="supplier_ket"
                                                   placeholder="Keterangan" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Jatuh
                                            Tempo </label>
                                        <div class="col-sm-10">
                                            <input type="text" id="supplier_jatuhtempo" name="supplier_jatuhtempo"
                                                   placeholder="Jatuh Tempo" class="col-xs-10 col-sm-5"/>
                                        </div>
                                    </div>

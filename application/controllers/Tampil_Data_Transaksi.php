...
class Tampil_Data_Transksi extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Mdl_tampildatatransaksi');
		$this->auth->restrict();
	...
	function index(){
     ...
     public function ajax_list() {
		$list = $this->Mdl_tampildatatransaksi->get_datatables();
		$data = array();
		$no = $_REQUEST['start'];
		...
		$output = array(
						"draw" => $_REQUEST['draw'],
						"recordsTotal" => $this->Mdl_tampildatatransaksi->count_all(),
						"recordsFiltered" => $this->Mdl_tampildatatransaksi->count_filtered(),
						"data" => $data,
				);

...
</style><?php $title = "<i class='fa fa-file-text-o'></i>&nbsp;Laporan Pembelian"; ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-0">
            ...
            <div>
                ...
                <div  id="cob">
                <a href="Laporan_Pembelian/cetak_rekap">
                <button class="btn btn-default" type="button"><i class="fa fa-print"> Laporan Pembelian Rekap</i></button></a></div>
                <div id="cob">
                <a href="Laporan_Pembelian/cetak_detail">
                <button class="btn btn-default" type="button"><i class="fa fa-print"> Laporan Pembelian Detail</i></button></a></div>
                <div id="cob">
                <a href="Laporan_Pembelian/cetak_harian">
                <button class="btn btn-default" type="button"><i class="fa fa-print"> Laporan Pembelian Harian</i></button></a></div>
                </div>
            </div>
        </div>
    </div>

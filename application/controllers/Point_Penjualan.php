...
class Point_Penjualan extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Mdl_pointpenjualan');
		$this->auth->restrict();
	...
	function index(){
       // $this->mdl_home->getsqurity();
        $data['view_file']    = "point_penjualan/view_point_penjualan";
        $this->load->view('admin_view',$data);
    }

    public function ajax_list() {
		$list = $this->Mdl_pointpenjualan->get_datatables();
		$data = array();
		$no = $_REQUEST['start'];
		...
		$output = array(
						"draw" => $_REQUEST['draw'],
						"recordsTotal" => $this->Mdl_pointpenjualan->count_all(),
						"recordsFiltered" => $this->Mdl_pointpenjualan->count_filtered(),
						"data" => $data,
				);

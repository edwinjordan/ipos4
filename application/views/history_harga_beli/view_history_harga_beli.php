<?php $title = "<i class='fa fa-tags'></i>&nbsp;History Harga Beli"; ?>
...
<div class="box-header">
	 ...
	 <form action="http://www.toko73wp.com/pembelian/pembelian_simpan" method="post" accept-charset="utf-8" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="col-xs-12">
              ...
              <div class="col-xs-1">
                <div class="form-group">
                  <a href="<?php echo base_url('History_Harga_Beli/cekitem') ?>">
...
<button class="btn btn-default btn-sm"><i class="fa fa-search" aria-hidden="true"></i></button></a>
        ...
        <div class="col-xs-12">
            ...
            <div class="col-xs-12">
              ...
              <div class="col-xs-2">
                <div class="form-group">
                  <a href="<?php echo base_url('History_Harga_Beli/ceksupplier') ?>"><button class="btn btn-default btn-sm"><i class="fa fa-search" aria-hidden="true"></i></button></a>
                </div>
              </div>
            </div>
  </form>
...
<script>
	var zonk=''; 
	var save_method;
	var link = "<?php echo site_url('History_Harga_Beli')?>";
	var table;
	...
	$(document).ready(function() {
        ...
        "ajax": {
            "url": "<?php echo site_url('History_Harga_Beli/ajax_list')?>",
            "type": "POST"
        },

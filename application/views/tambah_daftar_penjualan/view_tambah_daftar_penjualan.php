<?php $title = "<i class='fa fa-file-image-o'></i>&nbsp;Tambah Daftar Penjualan"; ?>
...
<script>
	var zonk=''; 
	var save_method;
	var link = "<?php echo site_url('Tambah_Daftar_Penjualan')?>";
	var table;
	...
	function tabel1 (){
        ...
        "ajax": {
            "url": "<?php echo site_url('Tambah_Daftar_Penjualan/ajax_list')?>",
            "type": "POST"
        },
	...
	function tabel2(){
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('Tambah_Daftar_Penjualan/ajax_list1')?>",
            "type": "POST"
        },

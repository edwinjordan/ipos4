...
class Tambah_Daftar_Pembelian extends CI_Controller {
	...
	function index(){
     ...
     public function ajax_list() {
		$list = $this->Mdl_tambahdaftarpembelian->get_datatables();
		$data = array();
		$no = $_REQUEST['start'];
		...
		$output = array(
						"draw" => $_REQUEST['draw'],
						"recordsTotal" => $this->Mdl_tambahdaftarpembelian->count_all(),
						"recordsFiltered" => $this->Mdl_tambahdaftarpembelian->count_filtered(),
						"data" => $data,
				);

...
class Tampil_Pelanggan extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Mdl_tampilpelanggan');
		$this->auth->restrict();
    ...
    public function ajax_list() {
		$list = $this->Mdl_tampilpelanggan->get_datatables();
		$data = array();
		$no = $_REQUEST['start'];
		...
		$output = array(
						"draw" => $_REQUEST['draw'],
						"recordsTotal" => $this->Mdl_tampilpelanggan->count_all(),
						"recordsFiltered" => $this->Mdl_tampilpelanggan->count_filtered(),
						"data" => $data,
				);

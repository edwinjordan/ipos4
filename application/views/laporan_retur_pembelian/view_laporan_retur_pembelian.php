...
<?php $title = "<i class='fa fa-file-text-o'></i>&nbsp;Laporan Retur Pembelian"; ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-0">
            ...
            <div>
                ...
                <div id="cob">
                <a href="Laporan_Retur_Pembelian/cetak_retur_rekap">
                <button class="btn btn-default" type="button"><i class="fa fa-print"> Laporan Retur Beli Rekap</i></button></div>
                <div>
                <a href="Laporan_Retur_Pembelian/cetak_retur_detail">
                <button class="btn btn-default" type="button"><i class="fa fa-print"> Laporan Retur Beli Detail</i></button></a></div><br>
                </div>
            </div>
        </div>
    </div>

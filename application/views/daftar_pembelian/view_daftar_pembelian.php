<?php $title = "<i class='fa fa-tags'></i>&nbsp;Daftar Pembelian"; ?>
...
<div class="box-header">
 ...
 <a href="<?php echo base_url('Daftar_Pembelian/tambah') ?>"><button class="btn btn-default" onclick="Tambah()"><i class="fa fa-plus"></i> Tambah Data</button></a>
</div><br />

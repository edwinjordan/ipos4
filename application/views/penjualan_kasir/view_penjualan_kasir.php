<?php $title = "<i class='fa fa-tags'></i>&nbsp;Penjualan Kasir"; ?>
...
<div class="box-header">
  ...
  <a href="<?php echo base_url('Penjualan_Kasir/tambah') ?>"><button class="btn btn-default" onclick="Tambah()"><i class="fa fa-plus"></i> Tambah Data</button>
  <button class="btn btn-default"><i class="fa  fa-file-text-o "></i> Laporan</button>
</div><br />
...
<script>
  var zonk=''; 
  var save_method;
  var link = "<?php echo site_url('Penjualan_Kasir')?>";
  var table;
  ...
  $(document).ready(function() {
    ...
    "bDestroy": true,
        ...
        "ajax": {
            "url": "<?php echo site_url('Penjualan_Kasir/ajax_list')?>",
            "type": "POST"
        },

<?php $title = "<i class='fa fa-tags'></i>&nbsp;Pesanan Penjualan"; ?>
...
<div class="box-header">
	...
	<a href="<?php echo base_url('Pesanan_Penjualan/tambah') ?>"><button class="btn btn-default" onclick="Tambah()"><i class="fa fa-plus"></i> Tambah Data</button></a>
</div><br />
...
<script>
	var zonk=''; 
	var save_method;
	var link = "<?php echo site_url('Pesanan_Penjualan')?>";
	var table;
	...
	$(document).ready(function() {
        ...
        "ajax": {
            "url": "<?php echo site_url('Pesanan_penjualan/ajax_list')?>",
            "type": "POST"
        },

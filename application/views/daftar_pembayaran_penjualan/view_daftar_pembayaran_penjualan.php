<?php $title = "<i class='fa fa-tags'></i>&nbsp;Daftar Pembayaran Piutang Penjualan"; ?>
...
<div class="box-header">
	...
	<a href="<?php echo base_url('Daftar_Pembayaran_Penjualan/tambah') ?>"><button class="btn btn-default" onclick="Tambah()"><i class="fa fa-plus"></i> Tambah Data</button>
</div></a><br />
...
<script>
	var zonk=''; 
	var save_method;
	var link = "<?php echo site_url('Daftar_Pembayaran_Penjualan')?>";
	var table;
	...
	$(document).ready(function() {
        ...
        "ajax": {
            "url": "<?php echo site_url('Daftar_Pembayaran_Penjualan/ajax_list')?>",
            "type": "POST"
        },

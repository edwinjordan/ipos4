<?php $title = "<i class='fa fa-tags'></i>&nbsp;Tambah Daftar Pembelian"; ?>
...
<br>
          ...
          <button class="btn btn-default" onclick="tambah()"><i class="fa fa-plus"></i> Tambah</button>
...
<script>
    var zonk=''; 
  var save_method;
  var link = "<?php echo site_url('Tambah_Daftar_Pembelian')?>";
  var table;
  ...
  $(document).ready(function() {
    ...
    "bDestroy": true,
        ...
        "ajax": {
            "url": "<?php echo site_url('Tambah_Daftar_Pembelian/ajax_list')?>",
            "type": "POST"
        },

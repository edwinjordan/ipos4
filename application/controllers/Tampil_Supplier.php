...
class Tampil_Supplier extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Mdl_tampilsupplier');
		$this->auth->restrict();
    ...
    public function ajax_list() {
		$list = $this->Mdl_tampilsupplier->get_datatables();
		$data = array();
		$no = $_REQUEST['start'];
		...
		$output = array(
						"draw" => $_REQUEST['draw'],
						"recordsTotal" => $this->Mdl_tampilsupplier->count_all(),
						"recordsFiltered" => $this->Mdl_tampilsupplier->count_filtered(),
						"data" => $data,
				);

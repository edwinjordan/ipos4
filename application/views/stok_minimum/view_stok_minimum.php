<?php $title = "<i class='fa fa-file-text-o'></i>&nbsp;Stok Minimum"; ?>
...
<div class="box-header">
            ...
            <div class="col-xs-12">
                ...
                <button class="btn btn-default" onclick="search_table()"><i class="fa fa-gear"> Proses</i></button>
                <br>
...
<br>
<button class="btn btn-default" onclick="cetak()"><i class="fa fa-print"> Cetak</i></button>
</div>
</div>
</div>
</div>

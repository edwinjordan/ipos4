...
class Tambah_Daftar_Pembayaran_Piutang_Penjualan extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Mdl_tambahdaftarpembayaranpiutangpenjualan');
		$this->auth->restrict();
    ...
    public function ajax_list() {
		$list = $this->Mdl_tambahdaftarpembayaranpiutangpenjualan->get_datatables();
		$data = array();
		$no = $_REQUEST['start'];
		...
		$output = array(
						"draw" => $_REQUEST['draw'],
						"recordsTotal" => $this->Mdl_tambahdaftarpembayaranpiutangpenjualan->count_all(),
						"recordsFiltered" => $this->Mdl_tambahdaftarpembayaranpiutangpenjualan->count_filtered(),
						"data" => $data,
				);

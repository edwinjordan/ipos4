...
class Tambah_Pesanan_Penjualan extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Mdl_tambahpesananpenjualan');
		$this->auth->restrict();
	...
	function index(){
       // $this->mdl_home->getsqurity();
        $data['view_file']    = "daftar_penjualan/view_tambah_pesanan_penjualan";
        $this->load->view('admin_view',$data);
    }

     public function ajax_list() {
		$list = $this->Mdl_tambahpesananpenjualan->get_datatables();
		$data = array();
		$no = $_REQUEST['start'];
		...
		$output = array(
						"draw" => $_REQUEST['draw'],
						"recordsTotal" => $this->Mdl_tambahpesananpenjualan->count_all(),
						"recordsFiltered" => $this->Mdl_tambahpesananpenjualan->count_filtered(),
						"data" => $data,
				);

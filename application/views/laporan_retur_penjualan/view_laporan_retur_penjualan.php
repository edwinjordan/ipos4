<?php $title = "<i class='fa fa-file-text-o'></i>&nbsp;Laporan Retur Penjualan"; ?>
                            ...
                            <div class="col-md-3 col-md-offset-0">
                                ...
                                <div>
                                    <div style="padding-bottom: 4px;">
                                        <a href="laporan_retur_penjualan/cetak_laporan_retur_jual_rekap">
                                        <button class="btn btn-default btn-l" onclick="cari()"><i
                                                    class="fa fa-print"> Laporan Retur Jual Rekap</i>
                                        </button></a>
                                    </div>
                                    <div>
                                        <a href="laporan_retur_penjualan/cetak_laporan_retur_jual_detail">
                                        <button class="btn btn-default btn-l" onclick="cari()"><i
                                                    class="fa fa-print"> Laporan Retur Jual Detail</i>
                                        </button></a>
                                    </div>
                                </div>
                            </div>

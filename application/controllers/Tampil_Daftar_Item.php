...
class Tampil_Daftar_Item extends CI_Controller {

	public function __construct() {
		parent::__construct();
		$this->load->model('Mdl_tampildaftaritem');
		$this->auth->restrict();
    ...
    public function ajax_list() {
		$list = $this->Mdl_tampildaftaritem->get_datatables();
		$data = array();
		$no = $_REQUEST['start'];
		...
		$output = array(
						"draw" => $_REQUEST['draw'],
						"recordsTotal" => $this->Mdl_tampildaftaritem->count_all(),
						"recordsFiltered" => $this->Mdl_tampildaftaritem->count_filtered(),
						"data" => $data,
				);

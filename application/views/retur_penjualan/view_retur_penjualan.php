<?php $title = "<i class='fa fa-file-text-o'></i>&nbsp;Retur Penjualan"; ?>
...
<!--                                    <form action="http://www.toko73wp.com/pembelian/pembelian_simpan" method="post" accept-charset="utf-8" class="form-horizontal" enctype="multipart/form-data">-->
                                ...
                                <a href="Retur_Penjualan/tambah">
                                <button class="btn btn-warning" onclick="Tambah()"><i class="fa fa-plus"></i> Tambah Data</button></a>
                                <button class="btn btn-default" onclick="Edit()"><i class="fa fa-edit"></i> Edit</button>

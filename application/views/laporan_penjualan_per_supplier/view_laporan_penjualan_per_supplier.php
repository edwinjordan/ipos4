<?php $title = "<i class='fa fa-file-text-o'></i>&nbsp;Laporan Penjualan Per Supplier"; ?>
                    ...
                    <div class="widget-main">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div>
                                    <div class="col-md-2" align="right"><span>Supplier</span><span> :</span></div>
                                    <div class="col-md-4">
                            ...
                            <div class="col-md-3 col-md-offset-0">
                                ...
                                <div>
                                    <div style="padding-bottom: 4px;">
                                        <a href="Laporan_Penjualan_per_Supplier/cetak_daftar_penjualan_per_supplier">
                                        <button class="btn btn-default btn-l" onclick="cari()"><i class="fa fa-print"> Laporan Jual Per Supplier</i></button></a>
                                    </div>
                                    <div style="padding-bottom: 4px;">
                                        <a href="Laporan_Penjualan_per_Supplier/cetak_daftar_penjualan_per_supplier_global">
                                        <button class="btn btn-default btn-l" onclick="cari()"><i class="fa fa-print"> Laporan Jual Per Supplier Global</i></button></a>
                                    </div>
                                </div>
                            </div>
